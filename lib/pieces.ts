...
export class PieceSvg {
  constructor(public path: string, public style: string) {}
}

const pieces = new Map<Piece, { black: string; white: string, }>([
  [
    Piece.pown,
    {
      black: "data:image/svg+xml; charset=utf8, " + encodeURIComponent(pawnBlackSvg),
      white: "",
    },
  ],
]);
